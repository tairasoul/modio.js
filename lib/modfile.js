...
var Modfile = /** @class */ (function () {
    function Modfile(tbl) {
        ...
        if (tbl.platforms.length > 0) {
            this.platforms = [];
            for (var _i = 0, _a = tbl.platforms; _i < _a.length; _i++) {
                var platform = _a[_i];
                for (var i = 0; i < tbl.platforms.length; i++) {
                    this.platforms[i] = {};
                    var tplat = this.platforms[i];
                    var tblplat = platform;
    ...
    Modfile.prototype.download = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var pipe;
            return __generator(this, function (_a) {
                (0, https_1.get)(this.binary_url, function (incoming) {
                    pipe = incoming.pipe((0, fs_1.createWriteStream)(path));
                });
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        pipe.on('finish', function () { return resolve; });
                        pipe.on('error', function () { return reject; });
                    })];
            });
        });
    };
